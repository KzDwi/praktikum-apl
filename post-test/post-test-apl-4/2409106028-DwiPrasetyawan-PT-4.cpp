    ...
    if (asal_Y > 0 && asal_Y <= MAX_Y && asal_X > 0 && asal_X <= MAX_X &&
        ...
        if (jenis == "mobil") {
            if (parkiranMobil[asal_Y - 1][asal_X - 1].platNomor != "" && 
                ...
                parkiranMobil[asal_Y - 1][asal_X - 1] = {}; //kosongkan posisi awal
            ...
            if (parkiranMotor[asal_Y - 1][asal_X - 1].platNomor != "" && 
                ...
                parkiranMotor[asal_Y - 1][asal_X - 1] = {}; //kosongkan posisi awal
                cout << "Kendaraan berhasil dipindahkan.\n";
            } else {
                cout << "Slot asal kosong atau slot tujuan sudah terisi!\n";
            }
...
void menuParkir() {
    ...
    do {
        ...
        switch (pilihan) {
            case 1: addKendaraan(); break;
            case 2: lihatParkir(); break;
            case 3: pindahKendaraan(); break;
            case 4: hapusKendaraan(); break;
            case 5: cout << "| Terima kasih telah menggunakan program ini! |" << endl; break;
